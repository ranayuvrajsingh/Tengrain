...
<g>
	<path fill="#4F9DA6" className="secondary-color dark-color" d="M55.9,487.5H21.2v-34.7h34.7V487.5z"></path>
	<path fill="#1A0841" className="primary-color accent-color" d="M493.9,56.2h-34.7V21.5h34.7V56.2z"></path>
	<path fill="#4F9DA6" className="secondary-color dark-color" d="M441.7,56.2h-34.7V21.5h34.7V56.2z"></path>
</g>
<linearGradient id="SVGID_1_coupon" gradientUnits="userSpaceOnUse" x1="269.6281" y1="369.0111" x2="269.6281" y2="154.1479">
        <stop offset="0" style={{ stopColor: '#93DF49' }} />
        <stop offset="1" style={{ stopColor: '#93DF49' }} />
      </linearGradient>
<path fill="url(#SVGID_1_coupon)" className="secondary-color accent-color" d="M387.5,363.8H151.8c-15,0-27.2-12.2-27.2-27.2V190.2c0-15,12.2-27.2,27.2-27.2h235.7
...
<path fill-rule="evenodd" className="accent-color" clip-rule="evenodd" fill="url(#SVGID_1_stats)" d="M478.6,185.3v217.2c0,8.2-6.7,14.9-14.9,14.9H237.9
...
<path fill="#4F9DA6" className="secondary-color dark-color" d="M469.4,100.3l-60.9-60.9h60.9V100.3z"></path>
...
export const CalculatorIcon: React.FC<React.SVGProps<SVGSVGElement>> = () => (
  ...
  <path fill="url(#SVGID_1_money)" className="accent-color" d="M403.8,87.1v373.3H103v-21.4c0,5.4,1-45.9,64-45.9l196.1,0.5c2.1,2.1,1-313.3,1-313.2h31.4
  ...
  <g>
    <path fill="#1A0841" className="primary-color accent-color" d="M438.8,344.5v-43.6h43.6v43.6H438.8z"></path>
    <path fill="#1A0841" className="primary-color accent-color" d="M438.8,425.1v-43.6h43.6v43.6H438.8z"></path>
    <path fill="#4F9DA6" className="secondary-color dark-color" d="M91.4,489H29v-70.1L91.4,489z"></path>
  </g>
  </svg>
);
...
<linearGradient id="SVGID_1_payment" gradientUnits="userSpaceOnUse" x1="180.9487" y1="147.8241" x2="344.8097" y2="147.8241">
	...
	<path fill="url(#SVGID_1_payment)" className="accent-color" d="M344.8,193.7l-119,89.3c0,0-31.8-23.6,22.1-57.9s23.6-64.7,23.6-64.7s-74.5-87-86.2-104.1
		c-11.8-17.1,4.4-43.6,4.4-43.6L344.8,193.7z"></path>
	 <linearGradient id="SVGID_1_gradient" gradientUnits="userSpaceOnUse" x1="270.9856" y1="499.2538" x2="270.9856" y2="323.9745">
        <stop offset="0" style={{ stopColor: '#93DF49' }} />
        <stop offset="1" style={{ stopColor: '#93DF49' }} />
      </linearGradient>
	<path fill="url(#SVGID_2_payment)" className="accent-color" d="M450.5,332.6v136.1c0,5.1-4.1,9.2-9.2,9.2h-14.2c-5.1,0-9.2-4.1-9.2-9.2V318.4
...
<path className="st1 dark-color" d="M430.7,299.1h-21.2c-11.3,0-21,6.4-25.9,15.7l-41.5-31.1c-0.4-0.3-0.8-0.5-1.1-0.7c-2.3-1.5-4.6-2.4-6.8-3.2l-0.1,0
...
<g>
	<path fill="#1A0841" className="primary-color accent-color" d="M48.5,291.7v35.2H27v-35.2H48.5z"></path>
	<path fill="#1A0841" className="primary-color accent-color" d="M48.5,355.6v35.2H27v-35.2H48.5z"></path>
	<path fill="#4F9DA6" className="secondary-color dark-color" d="M471.6,289.3l-31.4-31.4l31-31L471.6,289.3z"></path>
</g>
